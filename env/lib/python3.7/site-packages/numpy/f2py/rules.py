...
Rules for building C/src module with f2py2e.
...
""",
    ...
    {  # Debugging
        'routdebugenter': '\tfprintf(stderr,"debug-capi:Python C/src function #modulename#.#name#(#docsignature#)\\n");',
        'routdebugleave': '\tfprintf(stderr,"debug-capi:Python C/src function #modulename#.#name#: successful.\\n");',
        'routdebugfailure': '\tfprintf(stderr,"debug-capi:Python C/src function #modulename#.#name#: failure.\\n");',
        '_check': debugcapi
    }
]
...
def buildmodule(m, um):
    ...
    outmess('\tWrote C/src module "%s" to file "%s"\n' % (m['name'], fn))
