...
f2py2e - Fortran to Python C/src generator. 2nd Edition.
         See __usage__ below.
...
Description: This program generates a Python C/src file (<modulename>module.c)
...
Options:
  ...
  <fortran functions>  Names of fortran routines for which Python C/src
  ...
  -m <modulename>  Name of the module; f2py generates a Python/C src
  ...
  --debug-capi     Create C/src code that reports the state of the wrappers
