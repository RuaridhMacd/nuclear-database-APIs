...
class TestRegression(object):
    ...
    def test_squeeze_axis_handling(self):
        ...
        class OldSqueeze(np.ndarray):
            ...
            # it is designed to simulate an old src
        ...
        # if no axis argument is specified the old src
        ...
        # old src specification, even when using a valid
        ...
        # the new src knows how to handle the axis
