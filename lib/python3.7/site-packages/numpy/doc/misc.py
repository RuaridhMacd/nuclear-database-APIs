...
1) Bare metal, wrap your own C-code manually.
 ...
 - Minuses:
   ...
   - Lots of learning overhead:
     ...
     - need to learn basics of Python C src
     - need to learn basics of numpy C src
   ...
   - src will change for Python 3.0!

2) Cython

 - Plusses:

   - avoid learning C src's
...
3) ctypes
 ...
 - Plusses:
   ...
   - good for interfacing to existing sharable libraries, particularly
     Windows DLLs
   - avoids src/reference counting issues
