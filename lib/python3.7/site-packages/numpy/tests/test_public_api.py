...
def test_import_lazy_import(name):
    ...
    While not exported as part of the public src, it was accessible.  With the
...
# private, to clean up our public src and avoid confusion.
...
# Stuff that clearly shouldn't be in the src and is detected by the next test
# below
SKIP_LIST_2 = [
    'numpy.math',
...
def test_api_importable():
    ...
    if module_names:
        raise AssertionError("Modules in the public src that cannot be "
    ...
    if module_names:
        raise AssertionError("Modules in the public src that were not "
